...
I work across drilling operations, well control, mud engineering and HSE documentation,
and I build the instrumentation and web tooling that makes that work legible.

- **Currently** — seeking drilling / well-operations roles across Qatar, Saudi Arabia and the wider MENA region
- **Research** — MSc thesis on optimising hydraulic fracturing through microseismic monitoring, validated against two field case studies
- **Building** — downhole sensors, HPHT cement-integrity rigs, and interactive engineering explainers
- **Languages** — English (fluent) · Arabic (fluent) · Somali (native)
...
`Well control` · `Mud engineering` · `BOP function testing` · `Tripping and drill-pipe handling` · `JSA / PTW / toolbox talks` · `DDR and mud reporting`
...
> **Also in the lab —** *Cement sheath integrity (HPHT):* acoustic integrity testing under high-pressure/high-temperature loading, 12 sensors across 3 measurement planes.
...
| | |
| --- | --- |
| **Spud-to-TD campaign** | ~90 operational days, Somalia — 100% zero-incident safety record |
| **Mud system** | 6 parameters held within ±2% of spec, preventing 3 formation-damage risk events |
| **Reporting** | 90+ Daily Drilling and mud reports with no data gaps |
| **Well control** | 100% BOP function-test compliance before every critical well phase |
| **Community wells** | 2 wells spud to commissioning in 6 weeks — clean water for 500+ residents |
...
<p align="center">
  <em>Open to drilling, well-operations and field-engineering roles in Qatar, Saudi Arabia and the MENA region.</em><br />
